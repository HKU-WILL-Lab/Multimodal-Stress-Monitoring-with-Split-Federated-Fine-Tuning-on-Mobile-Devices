...
def _validate(config: AppConfig) -> None:
    ...
    if training.cut_layer < 0:
        raise InvalidRequest("cut_layer cannot be negative")
    if training.cut_layer >= 16:
        raise InvalidRequest("cut_layer must be below the 16-layer Llama 3.2 1B depth")
